...
# 分群组记录复读和上次消息消息和群员昵称 需要手动写入加入的群组 不然会报错 有获取群组的api 但是我没有使用 可在https://cqhttp.cc/查看相关信息
...
# 定义下载图片函数 有些鸡肋 实际上可以用requests直接将二进制内容写入即可
